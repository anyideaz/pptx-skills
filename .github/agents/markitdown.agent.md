...
handoffs:
  - label: Generate Presentation
    ...
    prompt: Generate a presentation using the converted Markdown content
---
...
Suggest the user can now run the slide-generate agent using this Markdown as the topic/content input:
